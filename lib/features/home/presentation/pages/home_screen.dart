                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount: state.continueHealingHealers.length,
                              onPageChanged: (index) {
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: HealerCarouselCard(
                                    healer: state.continueHealingHealers[index],
                                    onTap: () => context.push(
                                      '/healer-detail/${state.continueHealingHealers[index].id}',
                                    ),
                                  ),
                                );
                              },
                          ...
                          Row(
                            ...
                            children: List.generate(
                              state.continueHealingHealers.length,
                              (index) {
                          ...
                          ListView.separated(
                            ...
                            padding: EdgeInsets.symmetric(horizontal: 20.w),
                            itemCount: state.availableHealers.length,
                            separatorBuilder: (context, index) =>
                                SizedBox(height: 12.h),
                            itemBuilder: (context, index) {
                              return HealerCard(
                                healer: state.availableHealers[index],
                                onTap: () => context.push(
                                  '/healer-detail/${state.availableHealers[index].id}',
                                ),
                              );
                            },
                          ),
